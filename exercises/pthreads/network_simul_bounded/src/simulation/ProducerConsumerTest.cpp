...
const char* const usage =
  ...
  "  max_packages    maximum queue packet capacity[Optional]\n"
...
int ProducerConsumerTest::analyzeArguments(int argc, char* argv[]) {
  ...
  argc == 7 ? this->maxPackage = std::strtoull(argv[index++], nullptr, 10)
